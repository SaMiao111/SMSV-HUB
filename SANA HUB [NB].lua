...
mainFrame.Size = UDim2.new(0, 550, 0, 500)  -- 从350x310放大到550x500
...
titleBar.Size = UDim2.new(1, 0, 0, 55)  -- 从35放大到55
...
closeBtn.Size = UDim2.new(0, 45, 0, 45)  -- 从30放大到45
closeBtn.Position = UDim2.new(1, -55, 0, 5)
closeBtn.BackgroundColor3 = Color3.fromRGB(200, 50, 50)
closeBtn.BackgroundTransparency = 0.3
closeBtn.Text = "X"
closeBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
closeBtn.TextSize = 24  -- 从18放大到24
...
scrollContainer.Size = UDim2.new(1, -30, 1, -70)  -- 调整边距
scrollContainer.Position = UDim2.new(0, 15, 0, 60)
scrollContainer.BackgroundTransparency = 1
scrollContainer.ScrollBarThickness = 8  -- 从6放大到8
scrollContainer.CanvasSize = UDim2.new(0, 0, 0, 3000)
scrollContainer.Parent = mainFrame

local layout = Instance.new("UIListLayout")
layout.Padding = UDim.new(0, 12)  -- 从8放大到12
...
local function CreateSlider(name, min, max, default, suffix, callback)
    ...
    frame.Size = UDim2.new(1, 0, 0, 80)  -- 从55放大到80
    ...
    label.Size = UDim2.new(1, 0, 0, 28)  -- 从18放大到28
    label.Position = UDim2.new(0, 8, 0, 2)
    label.BackgroundTransparency = 1
    label.Text = name .. ": " .. tostring(default) .. suffix
    label.TextColor3 = Color3.fromRGB(220, 220, 220)
    label.TextSize = 16  -- 从11放大到16
    label.Font = Enum.Font.Gotham
    label.Parent = frame
    
    local slider = Instance.new("Frame")
    slider.Size = UDim2.new(1, -30, 0, 24)  -- 从16放大到24
...
local function CreateToggle(name, default, callback)
    if isDestroyed then return end
    local frame = Instance.new("Frame")
    frame.Size = UDim2.new(1, 0, 0, 45)  -- 从30放大到45
    frame.BackgroundColor3 = Color3.fromRGB(30, 30, 42)
    frame.BackgroundTransparency = 0.3
    frame.Parent = scrollContainer
    ...
    toggle.Size = UDim2.new(0, 40, 0, 26)  -- 从25x16放大到40x26
    ...
    indicator.Size = UDim2.new(0, 20, 0, 20)  -- 从12放大到20
...
local function CreateRegionFolder(regionName)
    ...
    folderBtn.Size = UDim2.new(1, 0, 0, 40)  -- 从28放大到40
    ...
    folderBtn.TextSize = 17  -- 从12放大到17
    ...
    contentLayout.Padding = UDim.new(0, 6)  -- 从4放大到6
...
local function CreateFixedTeleportPoint(name, position, regionFolder)
    ...
    local frame = Instance.new("Frame")
    frame.Size = UDim2.new(1, -15, 0, 38)  -- 从26放大到38
...
print("SANA HUB 已加载！按 INS 键切换菜单，点击右上角 X 完全卸载脚本")