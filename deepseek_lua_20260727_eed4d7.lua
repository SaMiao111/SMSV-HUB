...
local TouchService = game:GetService("TouchInputService") -- 手机触摸支持
...
screenGui.IgnoreGuiInset = true -- 手机端适配

-- ====== 悬浮窗按钮 (可拖动) ======
local floatingBtn = Instance.new("TextButton")
floatingBtn.Size = UDim2.new(0, 70, 0, 70) -- 放大
floatingBtn.Position = UDim2.new(0.02, 0, 0.5, -35)
floatingBtn.BackgroundColor3 = Color3.fromRGB(25, 25, 35)
floatingBtn.BackgroundTransparency = 0.3
floatingBtn.Text = "📌"
floatingBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
floatingBtn.TextSize = 32 -- 放大
...
UserInputService.InputChanged:Connect(function(input)
    if (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) and isDraggingFloat then
...
mainFrame.Size = UDim2.new(0, 480, 0, 480) -- 放大
...
titleBar.Size = UDim2.new(1, 0, 0, 45) -- 放大
titleBar.BackgroundColor3 = Color3.fromRGB(40, 40, 55)
titleBar.BackgroundTransparency = 0.3
titleBar.Parent = mainFrame

local titleBorder = Instance.new("UICorner")
titleBorder.CornerRadius = UDim.new(0, 6)
...
floatingBtn.MouseButton1Click:Connect(function()
    if isDraggingFloat then return end -- 防止点击触发拖动
...
scrollContainer.CanvasSize = UDim2.new(0, 0, 0, 0) -- 动态计算
scrollContainer.Parent = mainFrame

-- 修复手机端滑动
scrollContainer.ScrollingEnabled = true
scrollContainer.AutomaticCanvasSize = Enum.AutomaticSize.Y
scrollContainer.VerticalScrollBarPosition = Enum.VerticalScrollBarPosition.Right
...
local function CreateSection(text)
    ...
    secBorder.CornerRadius = UDim.new(0, 4)
...
local function CreateSlider(name, min, max, default, suffix, callback)
    ...
    fBorder.CornerRadius = UDim.new(0, 5)
...
local function CreateToggle(name, default, callback)
    ...
    toggle.Position = UDim2.new(1, -45, 0, 9)
    ...
    tBorder.CornerRadius = UDim.new(0, 11)
    tBorder.Parent = toggle
    
    local indicator = Instance.new("Frame")
    indicator.Size = UDim2.new(0, 16, 0, 16)
    indicator.Position = default and UDim2.new(0, 17, 0, 3) or UDim2.new(0, 2, 0, 3)
    indicator.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    indicator.Parent = toggle
    
    local iBorder = Instance.new("UICorner")
    iBorder.CornerRadius = UDim.new(0, 8)
    ...
    local function toggleState()
        ...
        indicator.Position = state and UDim2.new(0, 17, 0, 3) or UDim2.new(0, 2, 0, 3)
        callback(state)
    end
    ...
    clickArea.TouchTap:Connect(toggleState)
end
